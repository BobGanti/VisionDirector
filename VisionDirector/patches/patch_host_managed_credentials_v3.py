...
start_marker = '    @bp.get("/api/credentials/status")\n'
end_marker = '    @bp.route("/api/settings/supplier", methods=["GET", "POST"])\n'

if start_marker not in content:
    raise SystemExit("Could not find credentials status route marker.")
if end_marker not in content:
    raise SystemExit("Could not find supplier settings route marker.")
...
print("replaced credentials routes with host-managed non-blocking routes")
