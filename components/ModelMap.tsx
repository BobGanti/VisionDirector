...
import type { AspectRatio, ParsedScript, Sentiment, SpeechSpeed, VoiceProfile, ModelMapping } from "../types";
import { OpenAIService } from "../services/openaiService";

export const ModelMap: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  const mapData = [...GeminiService.getModelMap(), ...OpenAIService.getModelMap()];
  ...
  const handleSaveKeys = () => {
    ...
    // Reload so services pick up new keys immediately
      ...
      <div className="w-full max-w-6xl bg-[#0a0a0c] border border-white/10 rounded-[2rem] shadow-2xl p-8 lg:p-12 relative overflow-visible">
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start mb-12">
            <div>
              <h2 className="text-[12px] font-black uppercase tracking-[0.5em] text-violet-500 mb-2">
                Architectural Map
              </h2>
              ...
              <div className="mt-4 flex items-center gap-3 bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 rounded-xl w-fit">
                ...
                <p className="text-[10px] text-emerald-400 uppercase tracking-widest font-black">
                  Search project for{" "}
                  <span className="underline select-all">@MODEL_CALL_SITE</span>{" "}
                  to find code points.
                </p>
              </div>
            </div>
            ...
            {mapData.map((item, idx) => (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-[9px] uppercase font-black text-zinc-600 mb-1">
                      Configuration Key
                    </p>
                  ...
                  <div className="p-3 bg-black/40 rounded-xl border border-white/5">
                    <p className="text-[9px] uppercase font-black text-violet-500 mb-2">
                      Source Reference
                    </p>
            ...
            <div className="relative z-10">
              <div className="mb-6">
                ...
                <p className="text-[10px] text-zinc-500 mt-1 uppercase font-medium">
                  Override server-side variables with custom keys (Google and/or OpenAI) for persistent local access.
                </p>
              </div>
