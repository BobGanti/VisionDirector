...
old_rewrite_start = content.index("def _rewrite_runtime_js_urls(js: str) -> str:")
old_rewrite_end = content.index("\ndef _rewrite_index_asset_urls", old_rewrite_start)
...
content = content[:old_rewrite_start] + new_rewrite + content[old_rewrite_end + 1:]
